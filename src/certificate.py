...
class Certificate:
    ...
    def format_certificate(self):
        """ This function uses openssl to write the certificate in the right
        format and gathers meta-data.
        """
        # TODO: fix me
        pass
    ...
    def set_issuer(self):
        ...
        for component in issuer.get_components():
            self.issuer = component[0].decode('utf-8') + ':' + \
    ...
    def get_pub_key(self):
        ...
        self.pub_key = dump_publickey(
            FILETYPE_PEM, self.public_key).decode('utf-8')
